...
const UpdateProject = () => {
  ...
  const [gitFRepoLink, setGitFRepoLink] = useState("");
  const [gitERepoLink, setGitERepoLink] = useState("");
  ...
  useEffect(() => {
    const getProject = async () => {
      await axios
        .get(`https://portfolio-backend-neon-eight.vercel.app/api/v1/project/get/${id}`, {
        ...
        .then((res) => {
          ...
          setGitFRepoLink(res.data.project.gitFRepoLink);
          setGitERepoLink(res.data.project.gitERepoLink);
  ...
  const handleUpdateProject = (e) => {
    ...
    formData.append("gitFRepoLink", gitFRepoLink);
    formData.append("gitERepoLink", gitERepoLink);
                  ...
                  <div className="mt-2">
                    <div className="relative flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 ">
                      <input
                        ...
                        placeholder=" Github FrontEnd Repository Link"
                        value={gitFRepoLink}
                        onChange={(e) => setGitFRepoLink(e.target.value)}
                      />
                  ...
                  <div className="mt-2">
                    <div className="relative flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 ">
                      <input
                        type="text"
                        className="block flex-1 border-0 bg-transparent py-1.5 pl-8 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                        placeholder="Github Backend Repository Link"
                        value={gitERepoLink}
                        onChange={(e) => setGitERepoLink(e.target.value)}
                      />
                      <Link className="absolute w-5 h-5 left-1 top-2" />
                    </div>
                  </div>
